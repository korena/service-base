...
public class GlobalFilter implements Filter {
    ...
    /**
     * Return the filter configuration ob
     * @return ject for this filter.
     */
    ...
    public String toString() {
        ...
        StringBuilder sb = new StringBuilder("GlobalFilter(");
	...
	// You might, for example, wish to add a setParameter() method. To do this
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("GlobalFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("GlobalFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("GlobalFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("GlobalFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("GlobalFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
